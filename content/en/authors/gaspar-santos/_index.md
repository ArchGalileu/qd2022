...
bio: Membro fundador do [Quarteto Douro](/), [Camerata NovNorte](https://www.cameratanovnorte.eu) e Orquestra Clássica Invicta
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:myweb@gasparsantos.eu'
  - icon: chrome
    icon_pack: fab
    link: 'http://www.gasparsantos.eu'
#  - icon: twitter
#    icon_pack: fab
